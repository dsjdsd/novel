						...
						<div class="fxt-form">
							...
							@csrf
								<div class="form-group">
									...
									<input class="form-control" type="text" placeholder="Enter Email" name="email" id="email" value="{{ old('email') }}" required>
									</div>
								</div>
								<div class="form-group">
									<div class="fxt-transformY-50 fxt-transition-delay-2">
										<input id="password" type="password" class="form-control" id="password" name="password" value="{{ old('password') }}" placeholder="Mobile Number" required="required">
									</div>
								</div>
								<div class="form-group">
                                ...
                                <a href="{{route(name: 'registration')}}" class="switcher-text">New Registration</a>
								<div class="form-group">
