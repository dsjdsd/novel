          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"> Add Novel</h3>
              </div>
              
              <!-- /.card-header -->
              <div class="card-body">
              <form action="{{route('user-save-novel')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div id="editor" class="form-control" style="min-height: 150px;">{{old('description')}}</div>
                ...
                <div class="form-group">
                    ...
                    <div id="drop-area" style="border: 2px dashed #ccc; padding: 20px; text-align: center;">
                        ...
                        <input type="file" required name="document" class="form-control" id="file-upload" accept=".jpg, .jpeg, .png" style="display:none;">
                    </div>
